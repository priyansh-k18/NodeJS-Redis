...
// -> subscriber will consume this message
...
async function testAdditionalFeatures(){
    try{
        ...
        // const subscriber = client.duplicate(); //create a new client but it shares the same connection
        ...
        // multi.incrBy('account:0913:balance',100)
